                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" align="right" style="margin-bottom: 15px;">
                            ...
                            <a href="{{ url('/tambahpostscontent') }}" class="btn btn-info"><i
...
@section('extra_script')
    <script>
        ...
        $('#simpan').click(function() {
            ...
            $.ajax({
                type: "post",
                url: baseUrl + '/simpanpostscontent?_token=' + "{{ csrf_token() }}&" + $(
                    '.table_modal :input').serialize(),
                data: formdata,
        ...
        $(".uploadGambar").on('change', function() {
            ...
            if (typeof(FileReader) != "undefined") {
                ...
                reader.onload = function(e) {
                    image_holder.html(
                        '<img src="{{ asset('assets/demo/images/loading.gif') }}" class="img-responsive">');
