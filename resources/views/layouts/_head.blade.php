<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}" />
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/node_modules/select2-bootstrap-theme/dist/select2-bootstrap.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('assets/node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/bower_components/clockpicker/dist/jquery-clockpicker.min.css') }}"
        tppabs="http://www.bootstrapdash.com/demo/purple/bower_components/clockpicker/dist/jquery-clockpicker.min.css" />
    ...
    <link rel="stylesheet" href="{{ asset('assets/node_modules/icheck/skins/all.css') }}"
        tppabs="http://www.bootstrapdash.com/demo/purple/node_modules/icheck/skins/all.css">
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/node_modules/perfect-scrollbar/dist/css/perfect-scrollbar.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/node_modules/dropify/dist/css/dropify.min.css') }}"
        tppabs="http://www.bootstrapdash.com/demo/purple/node_modules/dropify/dist/css/dropify.min.css">
    ...
    <!-- Sertakan Leaflet CSS dan JS terlebih dahulu -->
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css"
        integrity="sha256-p4NxAoJBhIIN+hmNHrzRCf9tD/miZyoHS5obTRR9BMY=" crossorigin="" />
    <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>

    <!-- Sertakan leaflet-control-geocoder CSS dan JS -->
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/node_modules/fontawesome/web-fonts-with-css/css/fontawesome-all.min.css') }}" />
    {{-- validetta --}}
